// Zamieniona wersja PredictedCity.tsx na React Native
...
const PredictedCity = ({ city, country }: PredictedPlace) => {
    ...
    return (
        <TouchableOpacity style={styles.container} onPress={() => addCityToCitiesList(city!)}>
            <View style={styles.content}>
                <Ionicons name="location-outline" size={20} color="#DDDDDD" style={styles.icon} />
